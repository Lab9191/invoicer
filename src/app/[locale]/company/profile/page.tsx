              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center pt-8">
                    ...
                    />
                    <label htmlFor="is_vat_payer" className="ml-2 text-sm text-gray-700">
                      VAT Payer
                    </label>
                  </div>
                  ...
                  <div className="md:col-span-2">
                    <Textarea
                      ...
                      error={errors.registration_info?.message}
                      rows={3}
                      helperText="Additional registration details for invoices"
                    />
                  </div>
                </div>
              </CardContent>
